...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Title","Introduction to Con-PCA","Subscriptions","Templates","Customers","Sending Profiles","Landing Page","Recommendations","Tags","Users","Configuration","Glossary","Con-PCA Revision History","Introduction","Overview","Con-PCA Workflow","Create Subscription","Edit Subscription","Create New Template","Deception Calculator","Create New Customer","Create New Profile","Create New Landing Page","Create New Recommendation","Aggregate Statistics","Cycles","Testing","Tasks","Template Attributes","Subscriptions","Template Testing","Status Report","Cycle Report"],
    DREX_NODE_LINKS: ["index.htm","introduction_to_con_pca.htm","subscriptions_1.htm","templates.htm","customers.htm","sending_profiles.htm","landing_page.htm","recommendations.htm","tags.htm","users.htm","configuration.htm","glossary.htm","con_pca_revision_history.htm","introduction.htm","overview.htm","con_pca_workflow.htm","create_subscription.htm","edit_subscription.htm","create_new_template.htm","deception_calculator.htm","create_new_customer.htm","create_new_profile.htm","create_new_landing_page.htm","create_new_recommendation.htm","aggregate_statistics.htm","cycles.htm","testing.htm","tasks.htm","template_attributes.htm","subscriptions_2.htm","template_testing.htm","status_report.htm","cycle_report.htm"],
    DREX_NODE_CHILD_START: [1,13,16,18,20,21,22,23,24,24,24,25,25,25,25,25,25,25,28,31,31,31,31,31,31,31,33,33,33,33,33,33,33],
    DREX_NODE_CHILD_END: [13,16,18,20,21,22,23,24,24,24,25,25,25,25,25,25,25,28,31,31,31,31,31,31,31,33,33,33,33,33,33,33,33],
    DREX_MENU_TYPE: 2,
