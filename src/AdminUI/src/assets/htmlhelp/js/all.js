...
DR_EXPLAIN.data_menu = {
  ...
  DREX_NODE_LINKS: [
    ...
    "contacts.htm",
    "domains.htm",
    "sending_profiles.htm",
    "user_admin.htm",
    "glossary.htm",
    "con_pca_revision_history.htm",
    "introduction.htm",
    "overview.htm",
    "con_pca_workflow.htm",
    "system_requirements.htm",
    "installation_procedure.htm",
    "create_subscription.htm",
    "edit_subscription.htm",
    "create_new_template.htm",
    "deception_calculator.htm",
    "create_new_customer.htm",
    "create_new_contact.htm",
    "create_new_profile.htm",
  ],
