...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Title","Introduction to Con-PCA","System Basics","Subscriptions","Templates","Customers","Contacts","Domains","Sending Profiles","User Admin","Glossary","Con-PCA Revision History","Introduction","Overview","Con-PCA Workflow","System Requirements","Installation Procedure","Create Subscription","Edit Subscription","Create New Template","Deception Calculator","Create New Customer","Create New Contact","Create New Profile"],
    DREX_NODE_LINKS: ["index.htm","introduction_to_con_pca.htm","system_basics.htm","subscriptions.htm","templates.htm","customers.htm","contacts.htm","domains.htm","sending_profiles.htm","user_admin.htm","glossary.htm","con_pca_revision_history.htm","introduction.htm","overview.htm","con_pca_workflow.htm","system_requirements.htm","installation_procedure.htm","create_subscription.htm","edit_subscription.htm","create_new_template.htm","deception_calculator.htm","create_new_customer.htm","create_new_contact.htm","create_new_profile.htm"],
    DREX_NODE_CHILD_START: [1,12,15,17,19,21,22,23,23,24,24,24,24,24,24,24,24,24,24,24,24,24,24,24],
    DREX_NODE_CHILD_END: [12,15,17,19,21,22,23,23,24,24,24,24,24,24,24,24,24,24,24,24,24,24,24,24],
    DREX_MENU_TYPE: 2,
