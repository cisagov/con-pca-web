      ...
      if (this.recommendationsId != undefined) {
        this.subscriptions.push(
          this.recommendationsSvc
            .getRecommendation(this.recommendationsId)
            .subscribe((recommendationsData: Recommendations) => {
  ...
  setRecommendationsForm(recommendation: Recommendations) {
    ...
    this.recommendationsFormGroup = new FormGroup({
      ...
      logo_graphics: new FormControl(
        recommendation.appearance?.logo_graphics ?? 0
      ),
      organization: new FormControl(
        recommendation.relevancy?.organization ?? 0
      ),
